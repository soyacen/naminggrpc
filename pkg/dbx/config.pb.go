...
func (x *Config) Reset() {
	*x = Config{}
	mi := &file_pkg_dbx_config_proto_msgTypes[0]
...
func (*Config) Descriptor() ([]byte, []int) {
	return file_pkg_dbx_config_proto_rawDescGZIP(), []int{0}
}
...
func (x *Options) Reset() {
	*x = Options{}
	mi := &file_pkg_dbx_config_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Options) Descriptor() ([]byte, []int) {
	return file_pkg_dbx_config_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_dbx_config_proto protoreflect.FileDescriptor

const file_pkg_dbx_config_proto_rawDesc = "" +
	"\n" +
	"\x14pkg/dbx/config.proto\x12\x03dbx\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x86\x01\n" +
	"\x06Config\x122\n" +
	...
	"\x12conn_max_idle_time\x18\a \x01(\v2\x19.google.protobuf.DurationR\x0fconnMaxIdleTimeB'Z%github.com/soyacen/grocer/pkg/dbx;dbxb\x06proto3"

var (
	file_pkg_dbx_config_proto_rawDescOnce sync.Once
	file_pkg_dbx_config_proto_rawDescData []byte
)

func file_pkg_dbx_config_proto_rawDescGZIP() []byte {
	file_pkg_dbx_config_proto_rawDescOnce.Do(func() {
		file_pkg_dbx_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_dbx_config_proto_rawDesc), len(file_pkg_dbx_config_proto_rawDesc)))
	})
	return file_pkg_dbx_config_proto_rawDescData
}
...
func init() { file_pkg_dbx_config_proto_init() }
func file_pkg_dbx_config_proto_init() {
	if File_pkg_dbx_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_dbx_config_proto_rawDesc), len(file_pkg_dbx_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_dbx_config_proto_goTypes,
		DependencyIndexes: file_pkg_dbx_config_proto_depIdxs,
		MessageInfos:      file_pkg_dbx_config_proto_msgTypes,
	}.Build()
	File_pkg_dbx_config_proto = out.File
	file_pkg_dbx_config_proto_goTypes = nil
	file_pkg_dbx_config_proto_depIdxs = nil
}
